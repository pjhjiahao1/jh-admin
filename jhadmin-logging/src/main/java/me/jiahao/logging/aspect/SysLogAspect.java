package me.jiahao.logging.aspect;
...
import me.jiahao.logging.event.SysLogEvent;
import me.jiahao.logging.util.LogUtil;
...
public class SysLogAspect {
     ...
     */
    @Pointcut("@annotation(me.jiahao.logging.annotation.SysOperaLog)")
    ...
    public void recordLog(JoinPoint joinPoint) throws Throwable {
        ...
        sysLog.setIp(ip);
//        sysLog.setLocation(StringUtils.getLocalCityInfo(ip));
    ...
    public void doAfterReturning(Object ret) {
        //得到当前线程的log对象
        SysLogEntity sysLog = sysLogThreadLocal.get();
        // 处理完请求，返回内容
