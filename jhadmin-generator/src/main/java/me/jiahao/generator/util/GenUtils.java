package me.jiahao.generator.util;


import me.jiahao.generator.entity.ColumnEntity;
import me.jiahao.generator.entity.TableEntity;
...
//    }
    ...
    public static void generatorCode(Map<String, String> table,
                                     List<Map<String, String>> columns, ZipOutputStream zip, Map<String,Object> params) {
        //配置信息
        ...
        mainPath = StringUtils.isBlank(mainPath) ? "me.jiahao" : mainPath;
        //封装模板数据
        ...
        map.put("moduleName",  params.get("moduleName") /*config.getString("moduleName")*/);
        map.put("author", config.getString("author"));
        map.put("email", config.getString("email"));
        map.put("datetime", DateUtils.format(new Date(), DateUtils.DATE_TIME_PATTERN));
        map.put("jsPathName", params.get("jsPathName"));
        map.put("vuePathName", params.get("vuePathName"));
        map.put("menuCode", params.get("menuCode"));
//        map.put("moduleName", params.get("moduleName"));
        ...
        for (String template : templates) {
            ...
            try {
                //添加到zip
                zip.putNextEntry(new ZipEntry(getFileName(template, tableEntity.getClassName(), config.getString("package"), params.get("moduleName").toString() /*config.getString("moduleName")*/)));
...
//        }
        ...
        if (template.contains("mapper.xml.vm")) {
            return "main" + File.separator + "resources" + File.separator + "mapper" + File.separator + moduleName.replace(".", File.separator) + File.separator + className + "Mapper.xml";
        }
        ...
        if (template.contains("index.js.vm")) {
            return "main" + File.separator + "resources" + File.separator + "src" + File.separator + "vue" + File.separator + className.toLowerCase() + ".js";
        }
